...
- On the **gateway host**:
  - Store file: `~/.quantumcortex/agents/<agentId>/sessions/sessions.json` (per agent).
- Transcripts: `~/.quantumcortex/agents/<agentId>/sessions/<SessionId>.jsonl` (Telegram topic sessions use `.../<SessionId>-topic-<threadId>.jsonl`).
...
- many transcript/archive artifacts in `~/.quantumcortex/agents/<agentId>/sessions/`
