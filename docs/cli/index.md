...
- `--dev`: isolate state under `~/.quantumcortex-dev` and shift default ports.
- `--profile <name>`: isolate state under `~/.quantumcortex-<name>`.
...
- `--workspace <dir>`: agent workspace path (default `~/.quantumcortex/workspace`).
