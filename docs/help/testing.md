...
- Profile store: `~/.quantumcortex/credentials/` (preferred; what “profile keys” means in the tests)
...
- `OPENCLAW_CONFIG_DIR=...` (default: `~/.quantumcortex`) mounted to `/home/node/.quantumcortex`
- `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.quantumcortex/workspace`) mounted to `/home/node/.quantumcortex/workspace`
