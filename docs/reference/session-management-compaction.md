...
- Transcripts: `~/.quantumcortex/agents/<agentId>/sessions/<sessionId>.jsonl`
...
- `cron.runLog.maxBytes` + `cron.runLog.keepLines` prune `~/.quantumcortex/cron/runs/<jobId>.jsonl` files (defaults: `2_000_000` bytes and `2000` lines).
