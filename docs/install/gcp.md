...
```bash
mkdir -p ~/.quantumcortex
mkdir -p ~/.quantumcortex/workspace
```
...
OPENCLAW_CONFIG_DIR=/home/$USER/.quantumcortex
OPENCLAW_WORKSPACE_DIR=/home/$USER/.quantumcortex/workspace
