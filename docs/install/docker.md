...
`/home/node/.quantumcortex`, make sure your host bind mounts are owned by uid 1000.
...
- The gateway container is the source of truth for sessions (`~/.quantumcortex/agents/<agentId>/sessions/`).
...
- Agent workspace access: `workspaceAccess: "none"` (default) uses `~/.quantumcortex/sandboxes`
