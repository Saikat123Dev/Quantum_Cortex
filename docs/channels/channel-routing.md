...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.quantumcortex/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.quantumcortex`):

- `~/.quantumcortex/agents/<agentId>/sessions/sessions.json`
