...
```bash
OPENCLAW_CONFIG_PATH=~/.quantumcortex/main.json \
OPENCLAW_STATE_DIR=~/.quantumcortex-main \
openclaw gateway --port 18789

OPENCLAW_CONFIG_PATH=~/.quantumcortex/rescue.json \
OPENCLAW_STATE_DIR=~/.quantumcortex-rescue \
