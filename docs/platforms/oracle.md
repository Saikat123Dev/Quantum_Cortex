...
- **Credential permissions:** `chmod 700 ~/.quantumcortex`
...
- `~/.quantumcortex/` — config, credentials, session data
- `~/.quantumcortex/workspace/` — workspace (SOUL.md, memory, artifacts)

Back up periodically:

```bash
tar -czvf openclaw-backup.tar.gz ~/.quantumcortex ~/.quantumcortex/workspace
```
