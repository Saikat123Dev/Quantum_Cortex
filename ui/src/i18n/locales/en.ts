...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Edit ~/.quantumcortex/openclaw.json safely. (Quantum_Cortex config)",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from quantumcortex dashboard --no-open on your desktop.",
    },
    insecure: {
