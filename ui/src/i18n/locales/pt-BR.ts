...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.quantumcortex/openclaw.json com segurança.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando quantumcortex dashboard --no-open no desktop.",
    },
    insecure: {
