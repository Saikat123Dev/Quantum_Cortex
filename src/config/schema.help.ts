...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.store.path":
    "Sets where the SQLite memory index is stored on disk for each agent. Keep the default `~/.quantumcortex/memory/{agentId}.sqlite` unless you need custom storage placement or backup policy alignment.",
  ...
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.quantumcortex/extensions/<id>).",
