...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    ...safetySection,
    "## Quantum_Cortex CLI Quick Reference",
    "Quantum_Cortex is controlled via subcommands. Do not invent commands.",
    "To manage the Gateway daemon service (start/stop/restart):",
    "- quantumcortex gateway status",
    "- quantumcortex gateway start",
    "- quantumcortex gateway stop",
    "- quantumcortex gateway restart",
    "If unsure, ask the user to run `quantumcortex help` (or `quantumcortex gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
    // Skip self-update for subagent/none modes
    hasGateway && !isMinimal ? "## Quantum_Cortex Self-Update" : "",
    hasGateway && !isMinimal
      ? [
          ...
          "After restart, Quantum_Cortex pings the last active session automatically.",
        ].join("\n")
      : "",
    hasGateway && !isMinimal ? "" : "",
    "",
